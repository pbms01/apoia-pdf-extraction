...
const models: ModelOption[] = [
    ...
    { name: 'claude-sonnet-4-6', provider: 'Anthropic', providerKey: 'ANTHROPIC_API_KEY' },
    { name: 'claude-sonnet-4-5-20250514', provider: 'Anthropic', providerKey: 'ANTHROPIC_API_KEY' },
    { name: 'claude-haiku-4-5-20251001', provider: 'Anthropic', providerKey: 'ANTHROPIC_API_KEY' },
